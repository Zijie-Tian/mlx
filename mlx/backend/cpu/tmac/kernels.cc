...
extern "C"
#endif
 int32_t qgemm_lut_t1_int8_m160_k3200_n1_b2(void* A, void* LUT, void* Scales, void* LUT_Scales, void* LUT_Biases, void* C) {
  ...
  void* qgemm_lut_t1_int8_m160_k3200_n1_b2_A_shape = (NULL);
  void* qgemm_lut_t1_int8_m160_k3200_n1_b2_A_strides = (NULL);
  int32_t dev_id = (0);
  void* A_1 = (A);
  void* qgemm_lut_t1_int8_m160_k3200_n1_b2_LUT_shape = (NULL);
  void* qgemm_lut_t1_int8_m160_k3200_n1_b2_LUT_strides = (NULL);
  void* LUT_1 = (LUT);
  void* qgemm_lut_t1_int8_m160_k3200_n1_b2_Scales_shape = (NULL);
  void* qgemm_lut_t1_int8_m160_k3200_n1_b2_Scales_strides = (NULL);
  void* Scales_1 = (Scales);
  void* qgemm_lut_t1_int8_m160_k3200_n1_b2_LUT_Scales_shape = (NULL);
  void* qgemm_lut_t1_int8_m160_k3200_n1_b2_LUT_Scales_strides = (NULL);
  void* LUT_Scales_1 = (LUT_Scales);
  void* qgemm_lut_t1_int8_m160_k3200_n1_b2_LUT_Biases_shape = (NULL);
  void* qgemm_lut_t1_int8_m160_k3200_n1_b2_LUT_Biases_strides = (NULL);
  void* LUT_Biases_1 = (LUT_Biases);
  void* qgemm_lut_t1_int8_m160_k3200_n1_b2_C_shape = (NULL);
  void* qgemm_lut_t1_int8_m160_k3200_n1_b2_C_strides = (NULL);
  void* C_1 = (C);
  if (!(qgemm_lut_t1_int8_m160_k3200_n1_b2_A_strides == NULL)) {
  }
  if (!(qgemm_lut_t1_int8_m160_k3200_n1_b2_LUT_strides == NULL)) {
  }
  if (!(qgemm_lut_t1_int8_m160_k3200_n1_b2_Scales_strides == NULL)) {
  }
  if (!(qgemm_lut_t1_int8_m160_k3200_n1_b2_LUT_Scales_strides == NULL)) {
  }
  if (!(qgemm_lut_t1_int8_m160_k3200_n1_b2_LUT_Biases_strides == NULL)) {
  }
  if (!(qgemm_lut_t1_int8_m160_k3200_n1_b2_C_strides == NULL)) {
  }
  alignas(32) half CBits[160];
  alignas(32) half C_global[80];
  tbl_float_reset(160, (&(CBits[0])));
  for (int32_t k_outer = 0; k_outer < 50; ++k_outer) {
    tbl_g4_int8_float_update_strue_k16_b2_ak16_fafalse_zfalse_ostrue(160, (&(CBits[0])), (&(((int8_t*)LUT_1)[(k_outer * 256)])), (&(((uint8_t*)A_1)[(k_outer * 1280)])), (&(((half*)Scales_1)[0])), (&(((half*)LUT_Scales_1)[k_outer])), (&(((half*)LUT_Biases_1)[k_outer])));
  }
  for (int32_t m_c_outer = 0; m_c_outer < 3; ++m_c_outer) {
  ...
  for (int32_t m_inner_outer = 0; m_inner_outer < 3; ++m_inner_outer) {
    int32_t cse_var_18 = (m_inner_outer * 32);
    int32_t cse_var_17 = (cse_var_18 + 9);
    int32_t cse_var_16 = (cse_var_18 + 8);
    int32_t cse_var_15 = (cse_var_18 + 7);
    int32_t cse_var_14 = (cse_var_18 + 6);
    int32_t cse_var_13 = (cse_var_18 + 5);
    int32_t cse_var_12 = (cse_var_18 + 4);
    int32_t cse_var_11 = (cse_var_18 + 3);
    int32_t cse_var_10 = (cse_var_18 + 2);
    int32_t cse_var_9 = (cse_var_18 + 15);
    int32_t cse_var_8 = (cse_var_18 + 14);
    int32_t cse_var_7 = (cse_var_18 + 13);
    int32_t cse_var_6 = (cse_var_18 + 12);
    int32_t cse_var_5 = (cse_var_18 + 11);
    int32_t cse_var_4 = (cse_var_18 + 10);
    int32_t cse_var_3 = (cse_var_18 + 1);
...
extern "C"
 ...
 int32_t preprocessor_t1_int8_m3200_k3200_n1_b2(void* B, void* LUT_Scales, void* LUT_Biases, void* QLUT) {
  ...
  void* preprocessor_t1_int8_m3200_k3200_n1_b2_B_shape = (NULL);
  void* preprocessor_t1_int8_m3200_k3200_n1_b2_B_strides = (NULL);
  int32_t dev_id = (0);
  void* B_1 = (B);
  void* preprocessor_t1_int8_m3200_k3200_n1_b2_LUT_Scales_shape = (NULL);
  void* preprocessor_t1_int8_m3200_k3200_n1_b2_LUT_Scales_strides = (NULL);
  void* LUT_Scales_1 = (LUT_Scales);
  void* preprocessor_t1_int8_m3200_k3200_n1_b2_LUT_Biases_shape = (NULL);
  void* preprocessor_t1_int8_m3200_k3200_n1_b2_LUT_Biases_strides = (NULL);
  void* LUT_Biases_1 = (LUT_Biases);
  void* preprocessor_t1_int8_m3200_k3200_n1_b2_QLUT_shape = (NULL);
  void* preprocessor_t1_int8_m3200_k3200_n1_b2_QLUT_strides = (NULL);
  void* QLUT_1 = (QLUT);
  if (!(preprocessor_t1_int8_m3200_k3200_n1_b2_B_strides == NULL)) {
  }
  if (!(preprocessor_t1_int8_m3200_k3200_n1_b2_LUT_Scales_strides == NULL)) {
  }
  if (!(preprocessor_t1_int8_m3200_k3200_n1_b2_LUT_Biases_strides == NULL)) {
  }
  if (!(preprocessor_t1_int8_m3200_k3200_n1_b2_QLUT_strides == NULL)) {
  }
